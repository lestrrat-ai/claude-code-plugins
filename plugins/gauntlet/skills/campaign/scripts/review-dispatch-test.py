...
def t_external_attempt_two_has_native_attempt_three_recovery() -> None:
    ...
    check("`fallback-native` decision prepares fresh native fallback attempt `3`" in runtime,
          "runtime owner does not route a failed attempt 2 to native fallback attempt 3")
