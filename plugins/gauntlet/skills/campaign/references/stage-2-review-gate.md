...
The recorded repair's required clean base-only rebase is not a review precondition: `repair-pass.md`, **A
recorded repair may first take its required clean base-only rebase**, owns that one decided-repair path.
