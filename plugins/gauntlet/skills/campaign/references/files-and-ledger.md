...
| `review-<pr>-<n>.prompt.txt` | The fully substituted reviewer prompt for round `n`, launch attempt 1. Written as bytes through the host file API and passed as data through a native message field or quoted stdin — never embedded in shell source (`stage-2-review-gate.md`) |
